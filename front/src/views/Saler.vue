    ...
    <el-header>
      ...
      >
        <el-menu-item class="fr" index="1">
          <img src="../assets/login/sysu.jpg" alt="图片" width="70" height="50" />
        </el-menu-item>
        <el-menu-item class="fr" index="3">
          <router-link to="/" class="link-text">登陆页面</router-link>
        </el-menu-item>
      </el-menu>
    </el-header>
    <el-container>
          ...
          <el-col :span="19">
            ...
            >
              ...
              <!-- <el-menu-item index="4">
                ...
                <span slot="title">
                  <router-link to="/saler/purchase" class="link-text">进货信息表</router-link>
                </span>
              </el-menu-item>
