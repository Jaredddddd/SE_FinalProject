...
CREATE TABLE login (
    ...
    identity VARCHAR(10) NOT NULL CHECK (identity IN ('manager', 'saler', 'buyer'))
);
-- 2. 创建客户表
CREATE TABLE client (
...
-- 插入login表的测试数据
INSERT INTO login (username, password, identity) VALUES ('admin', '123', 'manager');
INSERT INTO login (username, password, identity) VALUES ('saler', '123', 'saler');
INSERT INTO login (username, password, identity) VALUES ('buyer', '123', 'buyer');
SELECT * FROM login;
